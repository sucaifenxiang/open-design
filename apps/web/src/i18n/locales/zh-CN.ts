...
export const zhCN: Dict = {
  ...
  "newproj.tabStoreScreenshot": "商店截图",
  "newproj.tabMedia": "媒体",
  "newproj.tabOther": "其它",
  ...
  "newproj.titleStoreScreenshot": "新建商店截图",
  "newproj.titleImage": "新建图片",
  "newproj.titleVideo": "新建视频",
  "newproj.titleAudio": "新建音频",
  "newproj.titleMedia": "新建媒体",
  "newproj.titleOther": "新建项目",
  "storeScreenshots.workspaceTitle": "商店截图",
  "storeScreenshots.platformAria": "商店平台",
  "storeScreenshots.appStore": "App Store",
  "storeScreenshots.googlePlay": "Google Play",
  "storeScreenshots.validationChecking": "校验中…",
  "storeScreenshots.validationReady": "可以导出",
  "storeScreenshots.validationIssues": "校验问题待处理",
  "storeScreenshots.validationUnavailable": "暂时无法校验",
  "storeScreenshots.generate": "使用 AI 生成",
  "storeScreenshots.generating": "正在生成…",
  "storeScreenshots.export": "导出",
  ...
  "storeScreenshots.thumbnailRail": "页面缩略图",
  "storeScreenshots.loadFailed": "无法加载商店截图。",
  "storeScreenshots.retry": "重试",
  "storeScreenshots.fineEdit": "精细编辑",
  "storeScreenshots.closeEditor": "关闭编辑器",
  "storeScreenshots.versionHistory": "版本历史",
  "storeScreenshots.closeVersions": "关闭版本历史",
  "storeScreenshots.pageActions": "页面操作",
  "storeScreenshots.addPage": "新增页面",
  "storeScreenshots.duplicatePage": "复制页面",
  "storeScreenshots.movePageLeft": "页面左移",
  "storeScreenshots.movePageRight": "页面右移",
  "storeScreenshots.lockPage": "锁定页面",
  "storeScreenshots.unlockPage": "解锁页面",
  "storeScreenshots.deletePage": "删除页面",
  "storeScreenshots.editorCanvas": "商店截图编辑画布",
  "storeScreenshots.editorInspector": "页面检查器",
  "storeScreenshots.headline": "标题",
  "storeScreenshots.body": "正文",
  "storeScreenshots.colors": "颜色",
  "storeScreenshots.backgroundColor": "背景颜色",
  "storeScreenshots.accentColor": "强调颜色",
  "storeScreenshots.textColor": "文字颜色",
  "storeScreenshots.productScreenshot": "产品截图",
  "storeScreenshots.noAsset": "未选择截图素材",
  "storeScreenshots.visibleOnPlatform": "在当前平台显示",
  "storeScreenshots.lockedFieldsNotice": "锁定字段不会被手工编辑或 AI 修改覆盖。",
  "storeScreenshots.reviewChanges": "审核修改",
  "storeScreenshots.reviewSummary": "共影响 {n} 个页面。应用前请检查前后差异。",
  "storeScreenshots.pageBefore": "第 {n} 页修改前",
  "storeScreenshots.pageAfter": "第 {n} 页修改后",
  "storeScreenshots.pageMissing": "此版本中没有该页面",
  "storeScreenshots.lockedChangesPreserved": "已保留锁定字段。",
  "storeScreenshots.previewFailed": "无法生成修改预览",
  "storeScreenshots.cancel": "取消",
  "storeScreenshots.applyChanges": "确认应用",
  "storeScreenshots.applyingChanges": "正在应用…",
  "storeScreenshots.noVersions": "暂无已保存版本。",
  "storeScreenshots.version": "版本 {n}",
  "storeScreenshots.currentVersion": "当前版本",
  "storeScreenshots.restore": "恢复",
  "storeScreenshots.restoreVersionNumber": "恢复版本 {n}",
  "storeScreenshots.restoreConfirmTitle": "恢复此版本？",
  "storeScreenshots.restoreConfirmBody": "将版本 {n} 恢复为当前文档？当前状态仍会保留在版本历史中。",
  "storeScreenshots.restoreVersion": "确认恢复",
  "storeScreenshots.restoring": "正在恢复…",
